...
export async function activate (context: vscode.ExtensionContext): Promise<void> {
    ...
    // Workspace Browser
    const workspaceBrowserProvider = new WorkspaceBrowserProvider(mvm)
    context.subscriptions.push(vscode.window.registerTreeDataProvider('matlab.workspaceBrowser', workspaceBrowserProvider))
    context.subscriptions.push(vscode.commands.registerCommand('matlab.refreshWorkspaceBrowser', () => workspaceBrowserProvider.refresh()))
